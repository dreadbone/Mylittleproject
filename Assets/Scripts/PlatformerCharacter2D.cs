...
public class PlatformerCharacter2D : MonoBehaviour
{
		...
		Transform groundCheck2; 							// A position marking where to check if the player is grounded.
...
//	float ceilingRadius = .01f;							// Radius of the overlap circle to determine if the player can stand up
		[HideInInspector]
		public Animator
				anim;										// Reference to the player's animator component.
...
//		ceilingCheck = transform.Find("CeilingCheck");
		...
		void Update ()
		{
				...
				grounded = (Physics2D.OverlapCircle (groundCheck1.position, groundedRadius, whatIsGround) || Physics2D.OverlapCircle (groundCheck2.position, groundedRadius, whatIsGround));
